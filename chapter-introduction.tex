...
\begin{description}[style=unboxed,leftmargin=0cm]
	...
	\item[sjasmplus 1.20.3 (\url{https://github.com/z00m128/sjasmplus})]\hfill
	...
	\item[CSpect 2.19.8.1 (\url{https://mdf200.itch.io/cspect})]\hfill
...
\begin{description}
	...
	Corrections and improvement based on more GitHub issues and one or two adjustments to port list based on current documentation. BJH.

	\item[\RevisionFourName]
	Corrections based on GitHub issues, most notably extended keyboard register fix. BJH.

	\item[\RevisionThreeName]
