...
\begingroup
	...
	\begin{tbbluereg}
		\nextport{R-}{00}{Identifies TBBlue board type. {\tt 10} on Next}
		\nextport{R-}{01}{Identifies core (FPGA image) version}
		\nextport{RW}{02}{Identifies type of last reset. Can be written to force reset}
		\nextport{RW}{03}{Identifies timing and machine type}
		\nextport{-W}{04}{In config mode, allows RAM to be mapped to ROM area}
		\nextport{RW}{05}{Sets joystick mode, video frequency and Scandoubler}
		\nextport{RW}{06}{Enables CPU Speed key, DivMMC, Multiface, Mouse and AY audio \ZXSee{06}}
		\nextport{RW}{07}{Sets CPU Speed, reads actual speed}
		\nextport{RW}{08}{ABC/ACB Stereo, Internal Speaker, SpecDrum, Timex Video Modes, Turbo Sound Next, RAM contention and (un)lock 128k paging \ZXSee{08}}
		\nextport{RW}{09}{Sets scanlines, AY mono output, sprite-id lockstep, resets DivMMC mapram and disables HDMI audio \ZXSee{09}}
		\nextport{RW}{0A}{Multiface, DivMMC, Mouse buttons and DPI config}
		\nextport{RW}{0B}{Joystick I/O Mode}
	...
	\begin{tbbluereg}
		\nextport{RW}{20}{Maskable Interrupt Control}
	...
	Registers \MemAddr{80} and above are inaccessible to the copper.
	...
	\begin{tbbluereg}
		...
		\nextport{R-}{B2}{Extended MD Pad Buttons}
		\nextport{RW}{B8-BB}{DivMMC configuration}
